...
<head>
    ...
    <title>Mail Coupon User VIP</title>
    <style>
        body {
...
<body>
    <div class="coupon">
        <div class="container">
            <h3>Mã khuyến mãi từ Nhà thuốc Yên tâm <a target="_blank" style="color: red"
        ...
        <div class="container" style="background-color: white">
            ...
            <p>Quý khách đã từng mua hàng tại Nhà thuốc Yên tâm <a target="_blank"
